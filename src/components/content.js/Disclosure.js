...
function DisclosureContent({ name, items }) {
  ...
  return (
    <Disclosure className="text-discord-shade-gray" as="div">
      {({ open }) => (
        <>
          <Disclosure.Button className="mt-2 font-semibold tracking-wider px-1 py-2 uppercase text-xs inline-flex flex-row items-center hover:text-discord-shade-grayLight">
            <HiChevronRight
